...
$this->addExternalCss(SITE_TEMPLATE_PATH . '/libs/jquery-ui/jquery-ui.min.css');
$this->addExternalJS(SITE_TEMPLATE_PATH . '/libs/jquery-ui/jquery-ui.min.js');
?>
							...
							<div class="bx-filter-block" data-role="bx_filter_block">
								<div class="row bx-filter-parameters-box-container">
									...
									<div class="col-xs-6 bx-filter-parameters-box-container-block bx-right">
										...
										<div class="bx-filter-input-container">1
											<input
												class="max-price"
												type="text"
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								case "A"://NUMBERS_WITH_SLIDER
									...
									<div class="row">
										<div class="col-md-12">
											<div id="slider-range_<?=$arItem['CODE']; ?>"></div>
										</div>
										<div class="form-group col col-md-6">
											<label for="">От
												<input type="text" name="<?=$arItem["VALUES"]["MIN"]["CONTROL_NAME"]?>" id="<?=$arItem["VALUES"]["MIN"]["CONTROL_ID"]?>" value="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>" class="form-control input-sm" onchange="smartFilter.keyup(this)">
											</label>
										</div>
										<div class="form-group col col-md-6">
											<label for="<?=$arItem["VALUES"]["MAX"]["CONTROL_ID"]?>">До
												<input type="text" name="<?=$arItem["VALUES"]["MAX"]["CONTROL_NAME"]?>" id="<?=$arItem["VALUES"]["MAX"]["CONTROL_ID"]?>" value="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>" class="form-control input-sm" onchange="smartFilter.keyup(this)">
											</label>
										</div>
									</div>
									...
									<script>
										$(document).ready(function() {
											$( "#slider-range_<?=$arItem['CODE']; ?>" ).slider({
												range: true,
												min: <?=$arItem["VALUES"]["MIN"]["VALUE"]?>,
												max: <?=$arItem["VALUES"]["MAX"]["VALUE"]?>,
												values: [<?=$arItem["VALUES"]["MIN"]["VALUE"]?>, <?=$arItem["VALUES"]["MAX"]["VALUE"]?>],
												slide: function(event, ui) {
													$("#<?=$arItem["VALUES"]["MIN"]["CONTROL_ID"]?>").attr("value" ,ui["values"][0]).change();
													$("#<?=$arItem["VALUES"]["MAX"]["CONTROL_ID"]?>").attr("value" ,ui["values"][1]).change();
												}
    										});
								...
								case "B"://NUMBERS
									...
									<div class="col-xs-6 bx-filter-parameters-box-container-block bx-right">
										<i class="bx-ft-sub"><?=GetMessage("CT_BCSF_FILTER_TO")?></i>
										<div class="bx-filter-input-container">3
											<input
												class="max-price"
												type="text"
												name="<?echo $arItem["VALUES"]["MAX"]["CONTROL_NAME"]?>"
								...
								case "U"://CALENDAR
									...
									<div class="col-xs-12">
										...
										<div class="bx-filter-parameters-box-container-block"><div class="bx-filter-input-container bx-filter-calendar-container">4
											<?$APPLICATION->IncludeComponent(
												'bitrix:main.calendar',
												'',
												array(
