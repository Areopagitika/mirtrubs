...
<ul class="pagination">
    <?if($arResult["bDescPageNumbering"] === true):?>
        ...
        <?if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
            <?if($arResult["bSavePage"]):?>
                <li class="page-item">
                    <a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["NavPageCount"]?>">Первая</a>
                </li>
                <li class="page-item">
            ...
            <?else:?>
                <li class="page-item">
                    <a class="page-link" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>">Первая</a>
                </li>
        ...
        <?if ($arResult["NavPageNomer"] > 1):?>
            ...
            <li class="page-item">
                <a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=1">Последняя</a>
            </li>
        <?else:?>
            <li class="page-item disabled">
                <a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=1">Последняя</a>
    ...
    <?else:?>
        ...
        <?if ($arResult["NavPageNomer"] > 1):?>
            ...
            <?if($arResult["bSavePage"]):?>
                <li class="page-item">
                    <a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=1">Первая</a>
                </li>
                <li class="page-item">
                    <a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>">&laquo;</a>
                </li>
        ...
        <?if($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
            ...
            <li class="page-item">
                <a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["NavPageCount"]?>">Последняя</a>
            </li>
        <?else:?>
            <li class="page-item disabled">
