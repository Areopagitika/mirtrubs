  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3">
        ...
        <ul>
          <li><a href="[[~22]]" title="Полиэтиленовые трубы для водоснабжения">ПНД трубы для воды</a></li>
          <li><a href="[[~23]]" title="Полиэтиленовые трубы для газопровода">ПНД трубы для газа</a></li>
          <li><a href="[[~24]]" title="Полиэтиленовые трубы для канализации">ПНД трубы для канализации</a></li>
        </ul>
      </div>
      <div class="col-md-3">
        <h4><a href="[[~27]]" title="Фитинги для труб">Фитинги</a></h4>
        <ul>
          <li><a href="[[~25]]" title="Фитинги электросварные для труб">Фитинги электросварные</a></li>
          <li><a href="[[~27]]" title="Фитинги сегментные для труб">Фитинги сегментные</a></li>
          <li><a href="[[~26]]" title="Фитинги литые для труб">Фитинги литые</a></li>
          <li><a href="[[~28]]" title="Фитинги компрессионные для труб">Фитинги компрессионные</a></li>
        </ul>
      </div>
      <div class="col-md-3">
        <h4><a href="[[~3]]" title="О компании ТрубПласт">О компании</a></h4>
        <ul>
          <li><a href="[[~16]]" title="История компании ТрубПласт">История компании</a></li>
          <li><a href="[[~17]]" title="Наш коллектив ТрубПласт">Наш коллектив</a></li>
          <li><a href="[[~18]]" title="Фотогалерея ТрубПласт">Фотогалерея</a></li>
          <li><a href="[[~19]]" title="Дипломы и благодарности ТрубПласт">Дипломы и благодарности</a></li>
        </ul>
      </div>
      <div class="col-md-3">
        <div class="phones">
...
<div class="modal fade today" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content text-left">
            <div class="modal-body">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <div class="modal-title">Сегодня в производстве - </div>
                {include 'today'}
...
<div class="modal fade order" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
